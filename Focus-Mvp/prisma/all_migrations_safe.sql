...
CREATE TABLE IF NOT EXISTS "BrainRule" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "description" TEXT,
...
CREATE TABLE IF NOT EXISTS "BrainRuleVersion" (
    "id" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "DataSource_organizationId_idx" ON "DataSource"("organizationId");
...
CREATE UNIQUE INDEX IF NOT EXISTS "Location_organizationId_code_key" ON "Location"("organizationId", "code");

CREATE INDEX IF NOT EXISTS "InventoryItem_organizationId_idx" ON "InventoryItem"("organizationId");

CREATE UNIQUE INDEX IF NOT EXISTS "InventoryItem_organizationId_productId_locationId_key" ON "InventoryItem"("organizationId", "productId", "locationId");

CREATE INDEX IF NOT EXISTS "Order_organizationId_idx" ON "Order"("organizationId");

CREATE UNIQUE INDEX IF NOT EXISTS "Order_organizationId_orderNumber_key" ON "Order"("organizationId", "orderNumber");

CREATE UNIQUE INDEX IF NOT EXISTS "BOMItem_parentId_childId_key" ON "BOMItem"("parentId", "childId");

CREATE INDEX IF NOT EXISTS "BrainRule_organizationId_idx" ON "BrainRule"("organizationId");

CREATE UNIQUE INDEX IF NOT EXISTS "BrainRule_organizationId_name_key" ON "BrainRule"("organizationId", "name");

CREATE UNIQUE INDEX IF NOT EXISTS "BrainRuleVersion_ruleId_version_key" ON "BrainRuleVersion"("ruleId", "version");

CREATE INDEX IF NOT EXISTS "AppInstance_organizationId_idx" ON "AppInstance"("organizationId");
...
CREATE UNIQUE INDEX IF NOT EXISTS "Connector_organizationId_name_key"
  ON "Connector"("organizationId", "name");

CREATE INDEX IF NOT EXISTS "Connector_organizationId_idx"
...
CREATE INDEX IF NOT EXISTS "ConnectorSync_connectorId_idx"
...
CREATE UNIQUE INDEX IF NOT EXISTS "OperationalRelationship_unique_edge"
...
CREATE INDEX IF NOT EXISTS "OperationalRelationship_source_idx"
  ON "OperationalRelationship"("organizationId", "sourceType", "sourceId");

CREATE INDEX IF NOT EXISTS "OperationalRelationship_target_idx"
  ON "OperationalRelationship"("organizationId", "targetType", "targetId");

CREATE INDEX IF NOT EXISTS "OperationalRelationship_type_idx"
...
CREATE INDEX IF NOT EXISTS "OperationalEvent_entity_idx"
  ON "OperationalEvent"("organizationId", "entityType", "entityId");

CREATE INDEX IF NOT EXISTS "OperationalEvent_time_idx"
  ON "OperationalEvent"("organizationId", "occurredAt");

CREATE INDEX IF NOT EXISTS "OperationalEvent_eventType_idx"
...
CREATE INDEX IF NOT EXISTS "MappingTemplate_organizationId_idx" ON "MappingTemplate"("organizationId");

CREATE UNIQUE INDEX IF NOT EXISTS "MappingTemplate_organizationId_name_key" ON "MappingTemplate"("organizationId", "name");
...
DO $$ BEGIN
  ALTER TABLE "BOMItem" ADD COLUMN     "scrapFactor" DECIMAL(6,4);
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
...
CREATE TABLE IF NOT EXISTS "MpsEntry" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "sku" TEXT NOT NULL,
    "period" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "ForecastEntry_organizationId_idx" ON "ForecastEntry"("organizationId");

CREATE INDEX IF NOT EXISTS "ForecastEntry_organizationId_sku_idx" ON "ForecastEntry"("organizationId", "sku");

CREATE UNIQUE INDEX IF NOT EXISTS "ForecastEntry_organizationId_sku_period_channel_version_key" ON "ForecastEntry"("organizationId", "sku", "period", "channel", "version");

CREATE INDEX IF NOT EXISTS "MpsEntry_organizationId_idx" ON "MpsEntry"("organizationId");

CREATE INDEX IF NOT EXISTS "MpsEntry_organizationId_sku_idx" ON "MpsEntry"("organizationId", "sku");

CREATE UNIQUE INDEX IF NOT EXISTS "MpsEntry_organizationId_sku_period_workCenter_key" ON "MpsEntry"("organizationId", "sku", "period", "workCenter");
...
CREATE INDEX IF NOT EXISTS "WorkOrder_organizationId_sku_idx" ON "WorkOrder"("organizationId", "sku");

CREATE UNIQUE INDEX IF NOT EXISTS "WorkOrder_organizationId_orderNumber_key" ON "WorkOrder"("organizationId", "orderNumber");

CREATE INDEX IF NOT EXISTS "Routing_organizationId_idx" ON "Routing"("organizationId");

CREATE INDEX IF NOT EXISTS "Routing_organizationId_sku_idx" ON "Routing"("organizationId", "sku");

CREATE UNIQUE INDEX IF NOT EXISTS "Routing_organizationId_sku_operationNo_key" ON "Routing"("organizationId", "sku", "operationNo");

CREATE INDEX IF NOT EXISTS "WorkCenter_organizationId_idx" ON "WorkCenter"("organizationId");

CREATE UNIQUE INDEX IF NOT EXISTS "WorkCenter_organizationId_code_key" ON "WorkCenter"("organizationId", "code");
...
DO $$ BEGIN
  ALTER TABLE "InventoryItem" ADD COLUMN     "qtyAllocated" DECIMAL(65,30) NOT NULL DEFAULT 0;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "InventoryItem" ADD COLUMN     "qtyAvailable" DECIMAL(65,30) NOT NULL DEFAULT 0;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "InventoryItem" ADD COLUMN     "qtyOnHand" DECIMAL(65,30) NOT NULL DEFAULT 0;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "InventoryItem" ADD COLUMN     "uom" TEXT NOT NULL DEFAULT '';
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "Product" ADD COLUMN     "reorderPoint" DECIMAL(65,30);
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "Product" ADD COLUMN     "safetyStock" DECIMAL(65,30);
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "Product" ADD COLUMN     "unitPrice" DECIMAL(65,30);
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "Product" ADD COLUMN     "uom" TEXT NOT NULL DEFAULT '';
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "Supplier" ADD COLUMN     "currency" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "actualStart" TIMESTAMP(3);
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "bomHeaderId" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "priority" INTEGER;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "productId" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "qtyPlanned" DECIMAL(65,30) NOT NULL DEFAULT 0;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "qtyProduced" DECIMAL(65,30) NOT NULL DEFAULT 0;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;

DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "qtyScrapped" DECIMAL(65,30) NOT NULL DEFAULT 0;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
...
DO $$ BEGIN
  ALTER TABLE "WorkOrder" ADD COLUMN     "woNumber" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL;
END $$;
...
CREATE TABLE IF NOT EXISTS "WorkOrderOperation" (
    "id" TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "QCResult" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS "Customer_orgId_code_key" ON "Customer"("orgId", "code");

CREATE INDEX IF NOT EXISTS "Equipment_orgId_idx" ON "Equipment"("orgId");

CREATE UNIQUE INDEX IF NOT EXISTS "Equipment_orgId_code_key" ON "Equipment"("orgId", "code");

CREATE INDEX IF NOT EXISTS "BOMHeader_orgId_idx" ON "BOMHeader"("orgId");

CREATE UNIQUE INDEX IF NOT EXISTS "BOMHeader_orgId_productId_version_key" ON "BOMHeader"("orgId", "productId", "version");

CREATE INDEX IF NOT EXISTS "Lot_orgId_idx" ON "Lot"("orgId");

CREATE UNIQUE INDEX IF NOT EXISTS "Lot_orgId_lotNumber_key" ON "Lot"("orgId", "lotNumber");

CREATE INDEX IF NOT EXISTS "StockMovement_orgId_productId_idx" ON "StockMovement"("orgId", "productId");

CREATE INDEX IF NOT EXISTS "StockMovement_orgId_occurredAt_idx" ON "StockMovement"("orgId", "occurredAt");

CREATE INDEX IF NOT EXISTS "PurchaseOrder_orgId_idx" ON "PurchaseOrder"("orgId");

CREATE UNIQUE INDEX IF NOT EXISTS "PurchaseOrder_orgId_poNumber_key" ON "PurchaseOrder"("orgId", "poNumber");

CREATE INDEX IF NOT EXISTS "SalesOrder_orgId_status_idx" ON "SalesOrder"("orgId", "status");

CREATE UNIQUE INDEX IF NOT EXISTS "SalesOrder_orgId_soNumber_key" ON "SalesOrder"("orgId", "soNumber");

CREATE UNIQUE INDEX IF NOT EXISTS "ProductionBatch_orgId_batchNumber_key" ON "ProductionBatch"("orgId", "batchNumber");

CREATE INDEX IF NOT EXISTS "QCInspection_orgId_status_idx" ON "QCInspection"("orgId", "status");
